  ...
  return (
    <div className="flex flex-col items-center justify-center text-center py-10 px-4">
      <div className="mb-10">
        ...
        <h2 className="text-[#252B42] font-bold text-[40px] md:text-[58px]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {cards.map((card, index) => (
          <div
            ...
            } shadow-md rounded-lg p-6 max-w-sm text-center transition-all`}
          >
            ...
            <button
              className={`${
                index === 1
                  ...
                  : "bg-transparent border border-[#23A6F0] text-[#23A6F0] hover:bg-[#23A6F0] hover:text-white"
              } font-bold py-4 px-6 rounded-full transition duration-300`}
            >
              {card.button}
            </button>
          </div>
      ...
      <div className="mt-16 py-10 text-center">
        ...
        {/* Button */}
        <button className="bg-[#23A6F0] text-[#FFFFFF] px-8 py-4 rounded-md m-4 hover:bg-blue-500 transition duration-300">
          Try it free now
        </button>
      </div>
    </div>
